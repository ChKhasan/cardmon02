...
class TodosDone extends Component {
  ...
  render() {
    ...
    const save = (e) => {
      ...
      if (this.props.todosDone.find((todo) => todo.todo === this.state.todo)) {
        this.setState({ isExist: true })
      } else {
        closeModalDone()
        const change = this.props.todosDone.find(
            ...
            {this.props.todosDone.map((todo, index) => (
              <tr>
                ...
                <td>
                  <Button
                    color="danger"
                    onClick={() => this.props.deletedTodoDone(todo)}
                  >
                    Delete
                  </Button>
                  <Button
